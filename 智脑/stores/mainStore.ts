  ...
  .object({
    ...
    settings: z
      .object({
        ...
        eldredWorldbookAutoInjectEnabled: z.boolean().prefault(false),
        eldredWorldbookAlwaysNames: z.string().prefault(''),
        eldredWorldbookScheduledNames: z.string().prefault(''),
        eldredWorldbookKeepEnabledNames: z.string().prefault(''),
        eldredWorldbookMaxEntries: z.coerce.number().prefault(8),
        eldredWorldbookMaxChars: z.coerce.number().prefault(9000),
        // 小总结独立API（廉价模型，如DS）
