...
const CANGXUAN_LOCATION_SCENE_PACKS: Array<{ anchors: string[]; entries: string[] }> = [
  ...
  {
    anchors: ['百草城', '丹霞谷'],
    entries: ['百草城', '丹霞谷', '贰叁捌', '金不换', '地狱火', '药芷若'],
  },
  {
    anchors: ['铁骨城', '万器山'],
  ...
  },
  {
    ...
    entries: ['百兽镇', '御兽宗', '万兽堂', '育兽塔', '百兽斗场', '化妖池', '毛绒绒', '颂长风'],
  },
  {
  ...
  {
    anchors: ['沧溟海阙', '星罗阵市'],
    entries: ['沧溟海阙', '沧无涯', '贝三娘', '陆潮生', '星罗阵市', '慕泽', '潮听澜'],
  },
  {
  ...
  },
  {
    ...
    entries: ['冰原雪域', '凌长霜', '玄霜宫', '白炉生', '风雪堂', '寒渊冰市', '宋听雪', '白夜裂谷', '雪照宁'],
  },
];
