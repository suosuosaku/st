    ...
    <div class="cangxuan-grid">
      <section class="cangxuan-section">
        ...
        <div class="cangxuan-limits">
          <label>最多条目 <input v-model.number="maxEntries" type="number" min="4" max="30" /></label>
          <label>最多字符 <input v-model.number="maxChars" type="number" min="3000" max="24000" step="500" /></label>
        </div>
