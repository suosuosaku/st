...
export const characterRaces: CharacterRace[] = [
  ...
  { id: 'dwarf', name: '矮人', summary: '灰炉、矿轨和锻造系统中常见，体质与力量稳定。', attributeBonus: { str: 1, vit: 1, dex: -1 }, auraName: '炉印手感', auraEffect: '锻造、矿石、装备耐久检查检定+1。' },
...
export const originLocations: OriginLocation[] = [
  ...
  { id: 'hammerfire-workshop', name: '锤火工坊街', regionId: 'gray-forge', landmarkName: '锤火工坊街', summary: '维修、锻造、装备耐久和炉心之锤线索贴得很近。', weather: '锻炉声盖过说话声，外套上很快落满铜粉。', trouble: '一把维修锤的校验号和炉壁档案不一致。', firstNpc: '工坊师傅' },
