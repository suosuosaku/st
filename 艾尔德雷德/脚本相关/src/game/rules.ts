...
export const characterRaces: CharacterRace[] = [
  { id: 'human', name: '人类', summary: '文书、行会、军役与商路覆盖最广，属性稳定。', attributeBonus: { vit: 1 }, auraName: '通行熟面', auraEffect: '登记、行会流程、普通城镇交涉检定+1。' },
  { id: 'elf', name: '精灵', summary: '月鹿森林与古歌传统出身，敏捷和精神表现更高。', attributeBonus: { dex: 1, spr: 1, str: -1 }, auraName: '月根感知', auraEffect: '药草、兽群、自然地脉观察检定+1。' },
  { id: 'half-elf', name: '半精灵', summary: '边界调停者，适应人类文书与精灵礼仪。', attributeBonus: { dex: 1, int: 1, vit: -1 }, auraName: '双界口音', auraEffect: '翻译、礼仪、跨族交涉检定+1。' },
  { id: 'dwarf', name: '矮人', summary: '灰炉、矿轨和锻造系统中常见，体质与力量稳定。', attributeBonus: { str: 1, vit: 1, dex: -1 }, auraName: '炉印手感', auraEffect: '锻造、矿石、装备校验检定+1。' },
  { id: 'halfling', name: '半身人', summary: '市集、铃扣商队与小路交通中灵活可靠。', attributeBonus: { dex: 1, spr: 1, str: -1 }, auraName: '小路熟客', auraEffect: '潜入、躲藏、市集询价检定+1。' },
  { id: 'gnome', name: '侏儒', summary: '铜壳机关街与学院工坊常见，智力和敏捷突出。', attributeBonus: { int: 1, dex: 1, vit: -1 }, auraName: '机关直觉', auraEffect: '机关、锁机、魔导器校准检定+1。' },
  { id: 'mirrorborn', name: '镜裔', summary: '镜塔自由市、镜面旅店和隐私法庭常见。', attributeBonus: { int: 1, spr: 1, str: -1 }, auraName: '镜面回声', auraEffect: '旧影像、幻象、身份伪装辨识检定+1。' },
  { id: 'tideborn', name: '潮裔', summary: '白帆群岛、潮裔珊瑚埠和灯塔水路常见。', attributeBonus: { vit: 1, dex: 1, int: -1 }, auraName: '潮汐呼吸', auraEffect: '游泳、潮汐、水路和海雾行动检定+1。' },
  { id: 'fae', name: '妖精', summary: '月鹿森林、妖精邮局和星苔溪谷常见，擅长轻捷魔法。', attributeBonus: { dex: 1, spr: 1, vit: -1 }, auraName: '铃粉轻步', auraEffect: '邮路、花粉、微型结界和短途潜行检定+1。' },
  { id: 'fae-blood', name: '妖精混血', summary: '常在城镇邮路、酒馆跑堂和边界市集中生活。', attributeBonus: { dex: 1, int: 1, str: -1 }, auraName: '半铃耳报', auraEffect: '听取传闻、误投包裹、桌边消息检定+1。' },
  { id: 'beastkin', name: '兽裔', summary: '兽铃草原、驿站和边寨常见，身体反应直接。', attributeBonus: { str: 1, dex: 1, int: -1 }, auraName: '野路嗅踪', auraEffect: '脚印、气味、驮兽状态和野外警觉检定+1。' },
  { id: 'orc', name: '兽人', summary: '红椒佣兵王国与边境工地常见，力量和耐受突出。', attributeBonus: { str: 1, vit: 1, int: -1 }, auraName: '赤岩硬骨', auraEffect: '搬运、角力、重武器维护和威吓检定+1。' },
  { id: 'goblin', name: '地精', summary: '暗市、矿洞旧线和废品工坊常见，手快脑快。', attributeBonus: { dex: 1, int: 1, spr: -1 }, auraName: '碎件嗅财', auraEffect: '废件搜罗、暗门、陷阱零件和小额交易检定+1。' },
  { id: 'dragonborn', name: '龙裔', summary: '旧誓家族、避誓塔和龙脉研究地带少量存在。', attributeBonus: { str: 1, spr: 1, dex: -1 }, auraName: '龙脉余温', auraEffect: '龙脉异常、古代誓约和威压抵抗检定+1。' },
  { id: 'tiefling', name: '魔裔', summary: '封印边缘、暗市法契和旧诅咒家系中少量存在。', attributeBonus: { int: 1, spr: 1, vit: -1 }, auraName: '咒痕耐性', auraEffect: '诅咒、契约、污染残响和禁忌符号辨识检定+1。' },
  { id: 'aasimar', name: '天裔', summary: '晨曦教会、极光修道院和旧祝圣家系中少量存在。', attributeBonus: { spr: 1, vit: 1, dex: -1 }, auraName: '晨曦余辉', auraEffect: '祝祷、污染安抚、教会礼仪和恐慌支援检定+1。' },
  { id: 'treeborn', name: '树裔', summary: '月鹿森林、翡翠温室和古树大厅少量存在。', attributeBonus: { vit: 1, spr: 1, dex: -1 }, auraName: '根须记忆', auraEffect: '植物、地脉湿度、木质机关和安抚检定+1。' },
  { id: 'wingborn', name: '羽裔', summary: '浮空圣都、廊桥、灯塔和高风航线常见。', attributeBonus: { dex: 1, spr: 1, str: -1 }, auraName: '高风落点', auraEffect: '高处移动、坠落自救、风向和空港礼仪检定+1。' },
  { id: 'frostborn', name: '雪裔', summary: '霜冠王国、白狼要塞和极光修道院常见。', attributeBonus: { vit: 1, spr: 1, dex: -1 }, auraName: '雪线耐受', auraEffect: '寒冷、雪盲、冰面行走和北境礼仪检定+1。' },
  { id: 'record-spirit', name: '记录灵', summary: '浮空圣都记录灵小厅与构装记录体常见。', attributeBonus: { int: 1, spr: 1, vit: -1 }, auraName: '索引回响', auraEffect: '档案索引、旧日程、断句复原和记录校验检定+1。' },
];
...
export const classTalents: ClassTalent[] = [
  ...
  { id: 'talent-artificer-tool', name: '工具列序', rank: 'S0', classId: 'artificer', effect: '拆解、校准、改装装备检定+1。' },
...
export const characterClasses: CharacterClass[] = [
  ...
  },
  {
    ...
    classAuraName: '校准习惯',
    classAuraEffect: '装备或机关校验时，可提前发现一次失效风险。',
    hpBase: 10,
    hpPerLevel: 5,
    mpBase: 6,
    mpPerLevel: 3,
...
export const originLocations: OriginLocation[] = [
  ...
  { id: 'windbell-guild', name: '风铃冒险者行会', regionId: 'seven-banners', landmarkName: '风铃冒险者行会', summary: '新手登记、风险印章和委托分级最先压到桌面。', weather: '柜台风铃被早班人群碰得乱响。', trouble: '一张低阶委托被反复改级，印章缺口对不上。', firstNpc: '妮娅' },
  { id: 'seven-banners-council', name: '七旗议会厅', regionId: 'seven-banners', landmarkName: '七旗议会厅', summary: '日期表、停会铃和空白页角把城邦记录摆在眼前。', weather: '侧厅茶水未凉，会议席还留着墨味。', trouble: '临时会议空页夹进了错误页角。', firstNpc: '帕琪 / 佩拉' },
  { id: 'little-hill-bell-market', name: '小丘铃市', regionId: 'seven-banners', landmarkName: '铃扣市集', summary: '商队、铃扣欠条和小路消息汇成轻松冒险入口。', weather: '摊棚铃扣被风吹得一阵乱响。', trouble: '一份欠条写着不存在的商队排班。', firstNpc: '托比' },
  ...
  { id: 'dawn-cathedral-aid', name: '晨曦大教堂救济侧厅', regionId: 'white-crown', landmarkName: '晨曦大教堂', summary: '救济名单、病历夹层和净化派压力交错。', weather: '湿披风挂满侧厅，药草水冒着淡汽。', trouble: '一页病历原件被副本压住，线脚颜色不一致。', firstNpc: '玛蒂 / 莉亚' },
  { id: 'royal-archive-counter', name: '王立档案馆调阅柜台', regionId: 'white-crown', landmarkName: '王立档案馆', summary: '许可、旧地图和缺页登记柜决定第一步能查到什么。', weather: '馆内干冷，调阅铃声在高架书柜间回响。', trouble: '一份旧地图室钥匙记录没有归还签名。', firstNpc: '蕾文' },
  ...
  { id: 'retreat-line-stakes', name: '灰雾撤回线木桩', regionId: 'gray-mist', landmarkName: '撤回线木桩', summary: '边境路线、绳结册和禁忌地入口压在脚边。', weather: '雾水顺着木桩往下淌，绳结册边角发软。', trouble: '撤回线多出一枚不在册的旧绳结。', firstNpc: '托兰娜' },
  { id: 'avoidance-tower-foot', name: '龙鳞避誓塔塔脚', regionId: 'gray-mist', landmarkName: '龙鳞避誓塔', summary: '避誓碑、龙脉热斑和旧封印维护页露出边角。', weather: '塔脚石缝发热，雾气贴地滚动。', trouble: '避誓碑裂纹在夜里重新发亮。', firstNpc: '奥薇线索' },
  ...
  { id: 'copper-shell-street', name: '铜壳机关街', regionId: 'star-sand', landmarkName: '铜壳机关街', summary: '机关铺、校准钟井和锁机停摆适合工匠开局。', weather: '街面有齿轮油味，校准钟敲得慢半拍。', trouble: '一张维修工单被塞进错误齿轮箱。', firstNpc: '露 / 工坊学徒' },
  { id: 'aerea-record-hall', name: '记录灵小厅', regionId: 'aerea', landmarkName: '记录灵小厅', summary: '旧日程、索引灯和外环断句把圣都记录线打开。', weather: '索引灯一盏接一盏亮起，又同时暗下去。', trouble: '一条旧日程被挪进无关分类。', firstNpc: '茜尔七号' },
  { id: 'silent-bell-tower', name: '沉默钟楼', regionId: 'aerea', landmarkName: '沉默钟楼', summary: '断响簿、无编号钟签和钟楼校时适合调查开局。', weather: '高处风冷，钟舌裂纹里积着黑铜粉。', trouble: '断响簿多出一段没有编号的钟签。', firstNpc: '贝琳' },
  { id: 'gray-forge-station', name: '灰炉矿轨大站', regionId: 'gray-forge', landmarkName: '矿轨大站', summary: '矿车账、炉壁档案和旧矿路线联动。', weather: '热风从轨道缝里冒出，矿车刹片发红。', trouble: '一节空矿车带回了不该存在的旧铭文灰。', firstNpc: '葛蕾娜' },
  { id: 'hammerfire-workshop', name: '锤火工坊街', regionId: 'gray-forge', landmarkName: '锤火工坊街', summary: '校验、锻造、武备改装和炉心之锤线索贴得很近。', weather: '锻炉声盖过说话声，外套上很快落满铜粉。', trouble: '一把工坊锤的校验号和炉壁档案不一致。', firstNpc: '工坊师傅' },
  ...
  { id: 'blue-heron-lighthouse', name: '蓝鹭灯塔', regionId: 'white-sail', landmarkName: '蓝鹭灯塔', summary: '航灯、暗光日志和潮汐缺口适合海路调查。', weather: '灯塔玻璃带盐霜，航灯闪得比表慢一拍。', trouble: '暗光日志的日期被新墨重描过。', firstNpc: '诺拉' },
  { id: 'tideborn-coral-port', name: '潮裔珊瑚埠', regionId: 'white-sail', landmarkName: '潮裔珊瑚埠', summary: '水门、潮门开合表和沉船圣坛把群岛线打开。', weather: '潮水没到栈桥第三阶，水门铃声发闷。', trouble: '潮门开合表少了一次夜航记录。', firstNpc: '潮裔港务员' },
  { id: 'moon-deer-forest-post', name: '月鹿森林妖精邮局', regionId: 'moon-deer', landmarkName: '妖精邮局', summary: '妖精邮路、月根残调和湿地小路适合轻捷开局。', weather: '邮袋挂在鹿角木架上，月苔还没完全收光。', trouble: '一封寄往七旗城的信被送到湿地祭坛。', firstNpc: '伊薇 / 邮路妖精' },
  { id: 'black-pine-gate', name: '黑松寨门', regionId: 'black-pine', landmarkName: '黑松寨门', summary: '边寨饭棚、木栅训练和旧雪路消息同时可见。', weather: '寨门木钉结霜，饭棚烟火贴着地面走。', trouble: '巡夜牌多出一枚不属于本寨的旧铃。', firstNpc: '边寨守夜人' },
...
export const skills: Skill[] = [
  ...
  s({ id: 'artificer-quick-rune', name: '急校铭文', rank: 'S1', sourceClasses: ['artificer'], source: '灰炉工坊', actionType: 'support', attribute: 'int', hitType: 'auto', target: '装备或机关', range: '近身', mpCost: 2, cooldown: 1, effects: ['装备命中或护甲+1至下回合'], desc: '消耗2法力；装备命中或护甲+1至下回合。' }),
...
export const equipmentPool: Equipment[] = [
  { id: 'worn-long-sword', name: '磨旧长剑', grade: '冒险级', slot: 'weapon', tags: ['长剑', '近战'], sourcePool: '圣骑士团退役武备', requirements: { str: 2 }, hitBonus: 1, damageBonus: 1, traits: ['近战伤害+1'] },
  { id: 'patched-round-shield', name: '补钉圆盾', grade: '冒险级', slot: 'shield', tags: ['盾牌'], sourcePool: '城门护送队', requirements: { str: 2 }, acBonus: 1, traits: ['护甲+1'] },
  { id: 'travel-mail', name: '旅行锁甲', grade: '冒险级', slot: 'upper', tags: ['轻甲'], sourcePool: '圣骑士团退役甲片', requirements: { str: 3 }, acBonus: 2, traits: ['护甲+2'] },
  { id: 'chalk-oak-staff', name: '粉笔橡木杖', grade: '冒险级', slot: 'weapon', tags: ['法杖', '导魔'], sourcePool: '星砂学院旧器材柜', requirements: { int: 3 }, hitBonus: 1, traits: ['法术命中+1'] },
  { id: 'student-robe', name: '防墨学生袍', grade: '生活级', slot: 'upper', tags: ['布甲', '学院'], sourcePool: '学院自治街', acBonus: 1, traits: ['护甲+1'] },
  { id: 'note-string', name: '绳页细绳', grade: '生活级', slot: 'tool', tags: ['文书', '工具'], sourcePool: '图书馆抄本柜', traits: ['文书整理目标值-1'] },
  { id: 'short-bow', name: '短猎弓', grade: '冒险级', slot: 'weapon', tags: ['弓', '远程'], sourcePool: '岚之领行会靶场', requirements: { dex: 3 }, hitBonus: 1, traits: ['远程命中+1'] },
  { id: 'waterproof-boots', name: '防水短靴', grade: '生活级', slot: 'boots', tags: ['旅行'], sourcePool: '白帆商队', traits: ['涉水路段目标值-1'] },
  { id: 'route-knife', name: '路标短刀', grade: '冒险级', slot: 'weapon', tags: ['短刀', '工具'], sourcePool: '边路向导', requirements: { dex: 2 }, traits: ['工具判定目标值-1'] },
  { id: 'iron-knuckle', name: '训练铁拳套', grade: '冒险级', slot: 'hands', tags: ['拳套', '近战'], sourcePool: '斗技训练场', requirements: { str: 3 }, hitBonus: 1, traits: ['近战命中+1'] },
  { id: 'training-vest', name: '厚革训练背心', grade: '冒险级', slot: 'upper', tags: ['轻甲'], sourcePool: '佣兵训练场', acBonus: 2, traits: ['护甲+2'] },
  { id: 'plain-belt', name: '结实腰带', grade: '生活级', slot: 'tool', tags: ['负重'], sourcePool: '行会杂货箱', traits: ['搬运小物件目标值-1'] },
  { id: 'corked-vial-kit', name: '软木塞药剂组', grade: '冒险级', slot: 'tool', tags: ['炼金', '药剂'], sourcePool: '炼金工坊', requirements: { int: 3 }, traits: ['炼金技能可用'] },
  { id: 'leather-apron', name: '防溅皮围裙', grade: '生活级', slot: 'upper', tags: ['工坊'], sourcePool: '炼金工坊', acBonus: 1, traits: ['护甲+1'] },
  { id: 'herb-satchel', name: '分格药草包', grade: '生活级', slot: 'tool', tags: ['药草'], sourcePool: '药草登记所', traits: ['药草辨识目标值-1'] },
  { id: 'copper-wrench', name: '铜壳扳手', grade: '冒险级', slot: 'weapon', tags: ['工具', '机关'], sourcePool: '铜壳机关街', requirements: { int: 2, str: 2 }, hitBonus: 1, traits: ['机关拆解可用'] },
  { id: 'tool-vest', name: '多袋工具背心', grade: '生活级', slot: 'upper', tags: ['工具'], sourcePool: '灰炉工坊', acBonus: 1, traits: ['小工具不易丢'] },
  { id: 'calibration-lamp', name: '校准小灯', grade: '冒险级', slot: 'tool', tags: ['魔导灯', '校准'], sourcePool: '灯塔与矿轨校准箱', requirements: { int: 3 }, traits: ['雾气或暗处调查目标值-1'] },
  { id: 'plain-holy-bell', name: '素面圣铃', grade: '冒险级', slot: 'tool', tags: ['圣铃', '祭司'], sourcePool: '晨曦大教堂侧厅', requirements: { spr: 3 }, traits: ['安抚与净化可用'] },
  { id: 'field-robe', name: '病房外勤袍', grade: '生活级', slot: 'upper', tags: ['医护'], sourcePool: '教会病房', acBonus: 1, traits: ['问诊信任+1'] },
  { id: 'casebook', name: '空白病历本', grade: '生活级', slot: 'tool', tags: ['文书', '医护'], sourcePool: '晨曦病房', traits: ['伤病记录可用'] },
  { id: 'chalk-contract-ring', name: '粉环契约器', grade: '冒险级', slot: 'ring', tags: ['召唤', '契约'], sourcePool: '召唤试验场', requirements: { spr: 3 }, traits: ['召唤技能可用'] },
  { id: 'summon-string', name: '防跑召唤绳', grade: '生活级', slot: 'tool', tags: ['召唤', '绳索'], sourcePool: '清理棚', traits: ['低阶使魔控制目标值-1'] },
  { id: 'npc-oath-saber', name: '誓约制式剑', grade: '精制级', slot: 'weapon', tags: ['长剑', '近战', '圣骑士'], sourcePool: '固定NPC制式装备', requirements: { str: 5 }, hitBonus: 2, damageBonus: 2, traits: ['近战命中+2', '近战伤害+2'] },
  { id: 'npc-oath-shield', name: '誓约纹章盾', grade: '精制级', slot: 'shield', tags: ['盾牌', '守护'], sourcePool: '固定NPC制式装备', requirements: { vit: 5 }, acBonus: 2, traits: ['护甲+2', '守护动作目标值-1'] },
  { id: 'npc-mail-coat', name: '巡防锁环外甲', grade: '精制级', slot: 'upper', tags: ['轻甲', '巡防'], sourcePool: '固定NPC制式装备', requirements: { vit: 5 }, acBonus: 2, traits: ['护甲+2'] },
  { id: 'npc-archive-staff', name: '档案导魔杖', grade: '精制级', slot: 'weapon', tags: ['法杖', '导魔', '文书'], sourcePool: '固定NPC制式装备', requirements: { int: 6 }, hitBonus: 2, damageBonus: 1, traits: ['法术命中+2', '法术伤害+1'] },
  { id: 'npc-ward-robe', name: '防咒长袍', grade: '精制级', slot: 'upper', tags: ['布甲', '防咒'], sourcePool: '固定NPC制式装备', requirements: { int: 5 }, acBonus: 1, traits: ['护甲+1', '智力检定+1'] },
  { id: 'npc-ledger-satchel', name: '封签文书挎包', grade: '冒险级', slot: 'tool', tags: ['文书', '封签'], sourcePool: '固定NPC制式装备', traits: ['文书复核目标值-1'] },
  { id: 'npc-field-bow', name: '巡路短弓', grade: '精制级', slot: 'weapon', tags: ['弓', '远程', '巡路'], sourcePool: '固定NPC制式装备', requirements: { dex: 5 }, hitBonus: 2, damageBonus: 1, traits: ['远程命中+2', '远程伤害+1'] },
  { id: 'npc-route-boots', name: '防滑巡路靴', grade: '冒险级', slot: 'boots', tags: ['旅行', '机动'], sourcePool: '固定NPC制式装备', requirements: { dex: 3 }, traits: ['移动与追踪目标值-1'] },
  { id: 'npc-route-knife', name: '折标短刀', grade: '冒险级', slot: 'tool', tags: ['短刀', '工具'], sourcePool: '固定NPC制式装备', requirements: { dex: 3 }, traits: ['陷阱处理目标值-1'] },
  { id: 'npc-guard-saber', name: '压阵弯刀', grade: '精制级', slot: 'weapon', tags: ['弯刀', '近战', '压制'], sourcePool: '固定NPC制式装备', requirements: { str: 5 }, hitBonus: 2, damageBonus: 2, traits: ['近战命中+2', '压制伤害+2'] },
  { id: 'npc-guard-mail', name: '厚革护胸', grade: '精制级', slot: 'upper', tags: ['轻甲', '护胸'], sourcePool: '固定NPC制式装备', requirements: { vit: 5 }, acBonus: 2, traits: ['护甲+2'] },
  { id: 'npc-guard-gauntlet', name: '挡拆护手', grade: '冒险级', slot: 'hands', tags: ['护手', '格挡'], sourcePool: '固定NPC制式装备', requirements: { str: 3 }, traits: ['反应格挡减伤+1'] },
  { id: 'npc-reagent-dart', name: '试剂短镖', grade: '精制级', slot: 'weapon', tags: ['短镖', '炼金'], sourcePool: '固定NPC制式装备', requirements: { int: 5 }, hitBonus: 2, damageBonus: 1, traits: ['炼金攻击命中+2', '炼金伤害+1'] },
  { id: 'npc-reagent-apron', name: '防蚀炼金围裙', grade: '精制级', slot: 'upper', tags: ['工坊', '防蚀'], sourcePool: '固定NPC制式装备', requirements: { vit: 4 }, acBonus: 1, traits: ['护甲+1', '毒素豁免+1'] },
  { id: 'npc-reagent-kit', name: '随身试剂箱', grade: '精制级', slot: 'tool', tags: ['炼金', '药剂'], sourcePool: '固定NPC制式装备', requirements: { int: 5 }, traits: ['炼金技能可用', '药剂处理目标值-1'] },
  { id: 'npc-rivet-hammer', name: '铆钉战锤', grade: '精制级', slot: 'weapon', tags: ['锤', '机关', '近战'], sourcePool: '固定NPC制式装备', requirements: { str: 5, int: 3 }, hitBonus: 2, damageBonus: 2, traits: ['近战命中+2', '构装目标伤害+2'] },
  { id: 'npc-work-coat', name: '耐磨工匠外套', grade: '精制级', slot: 'upper', tags: ['工坊', '护具'], sourcePool: '固定NPC制式装备', requirements: { vit: 4 }, acBonus: 1, traits: ['护甲+1', '机关事故减伤+1'] },
  { id: 'npc-rivet-kit', name: '铆钉工具盒', grade: '冒险级', slot: 'tool', tags: ['机关', '维修'], sourcePool: '固定NPC制式装备', requirements: { int: 4 }, traits: ['机关维修目标值-1'] },
  { id: 'npc-prayer-rod', name: '祈光短杖', grade: '精制级', slot: 'weapon', tags: ['圣铃', '治疗', '导魔'], sourcePool: '固定NPC制式装备', requirements: { spr: 5 }, hitBonus: 2, damageBonus: 1, traits: ['祈祷命中+2', '治疗量+1'] },
  { id: 'npc-prayer-robe', name: '净纹外勤袍', grade: '精制级', slot: 'upper', tags: ['医护', '净化'], sourcePool: '固定NPC制式装备', requirements: { spr: 4 }, acBonus: 1, traits: ['护甲+1', '净化检定+1'] },
  { id: 'npc-reliquary', name: '小圣匣', grade: '冒险级', slot: 'tool', tags: ['治疗', '净化'], sourcePool: '固定NPC制式装备', requirements: { spr: 4 }, traits: ['治疗与净化可用'] },
  { id: 'npc-contract-rod', name: '契约短杖', grade: '精制级', slot: 'weapon', tags: ['召唤', '契约', '导魔'], sourcePool: '固定NPC制式装备', requirements: { spr: 5 }, hitBonus: 2, damageBonus: 1, traits: ['召唤命中+2', '契约伤害+1'] },
  { id: 'npc-contract-ring', name: '稳相契约环', grade: '精制级', slot: 'ring', tags: ['召唤', '契约'], sourcePool: '固定NPC制式装备', requirements: { spr: 5 }, traits: ['召唤控制目标值-1'] },
  { id: 'npc-circle-chalk', name: '防断线粉笔盒', grade: '冒险级', slot: 'tool', tags: ['召唤', '工具'], sourcePool: '固定NPC制式装备', traits: ['召唤圈处理目标值-1'] },
  { id: 'dawn-shield-fragment', name: '拂晓盾纹残片', grade: '圣遗级', slot: 'shield', tags: ['神器线索', '盾牌'], sourcePool: '拂晓之盾旧誓页', requirements: { spr: 12, vit: 8 }, acBonus: 2, traits: ['短时护甲+2'] },
  { id: 'storm-key-splinter', name: '风暴钥齿', grade: '圣遗级', slot: 'tool', tags: ['神器线索', '机关'], sourcePool: '风暴之钥残页', requirements: { dex: 12, int: 8 }, traits: ['旧门检定+2'] },
  { id: 'star-cup-echo', name: '星灯杯影', grade: '神器级', slot: 'tool', tags: ['神器载体', '治疗', '星灯'], sourcePool: '星灯之杯旧光', requirements: { level: 16, int: 16, spr: 14 }, traits: ['S5治疗载体'] },
];
...
export const generateEquipmentName = (seed = 0) => {
  const pools = {
    ...
    forms: ['长剑', '短弓', '盾', '外袍', '手套', '短靴', '戒指', '药剂袋', '校准灯', '契约器', '校准钳'],
  };
